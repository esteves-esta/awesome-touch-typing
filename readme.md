# List of Touch Typing Resources


> An list of applications for learning and practicing touch typing.
...
##### Languages
- Various languages (40 languages)

##### Features
- Keyboard Settings (show/hide/layout)
- Lessons
- Finger Placement
- Adaptive Practice
- AI Coach
...
- Acessibility (Font size, Type of Font, Voice over, Subtitles) 
...
##### Features
- Practice with Random Words
- Settings: difficulty & codifiers
- Sound Cues

---

#### [Cryptmaster](https://www.akuparagames.com/game/cryptmaster/) [ PAID ]
The dungeon-crawling adventure is all about finding the right word for a whole bunch of different wacky scenarios. Typing is how you use that power. [credtis: Polygon Review](https://www.polygon.com/24203891/cryptmaster-impressions-word-games)

##### Available in 
- Various

##### Features
- Practice with Random Words, Word Puzzles
...
##### Features
- Practice with: random words or custom test
- Multiplayer
- Settings (duration/wordlist)
...
- Duration of test
- Strict mode
- Custom text or choose type of text (technical/numbers/code)
...
##### Features
- Practice with sentences or paragraph
...
##### Features
- Practice with: sentences or words
- Settings: just lowercase / font
- Theme 
